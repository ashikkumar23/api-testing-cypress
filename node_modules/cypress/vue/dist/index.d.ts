...
declare function mount$1<T, C = T extends ((...args: any) => any) | (new (...args: any) => any) ? T : T extends {
    props?: infer Props;
} ? DefineComponent<Props extends Readonly<(infer PropNames)[]> | (infer PropNames)[] ? {
    [key in PropNames extends string ? PropNames : string]?: any;
} : Props> : DefineComponent, P extends ComponentProps<C> = ComponentProps<C>>(originalComponent: T, options?: ComponentMountingOptions$1<C, P>): VueWrapper<ComponentProps<C> & ComponentData<C> & ComponentExposed<C>, ComponentPublicInstance<ComponentProps<C>, ComponentData<C> & ComponentExposed<C> & Omit<P, keyof ComponentProps<C>>>>;
declare const shallowMount: typeof mount$1;
...
declare const RouterLinkStub: vue.DefineComponent<{
    to: {
...
declare const config: GlobalConfigOptions;
...
type _VueTestUtils_BaseWrapper<ElementType extends Node> = BaseWrapper<ElementType>;
declare const _VueTestUtils_BaseWrapper: typeof BaseWrapper;
type _VueTestUtils_DOMWrapper<NodeType extends Node> = DOMWrapper<NodeType>;
declare const _VueTestUtils_DOMWrapper: typeof DOMWrapper;
declare const _VueTestUtils_RouterLinkStub: typeof RouterLinkStub;
type _VueTestUtils_VueWrapper<VM = unknown, T extends ComponentPublicInstance = VM & ComponentPublicInstance> = VueWrapper<VM, T>;
declare const _VueTestUtils_VueWrapper: typeof VueWrapper;
declare const _VueTestUtils_config: typeof config;
declare const _VueTestUtils_createWrapperError: typeof createWrapperError;
declare const _VueTestUtils_disableAutoUnmount: typeof disableAutoUnmount;
declare const _VueTestUtils_enableAutoUnmount: typeof enableAutoUnmount;
declare const _VueTestUtils_flushPromises: typeof flushPromises;
declare const _VueTestUtils_renderToString: typeof renderToString;
declare const _VueTestUtils_shallowMount: typeof shallowMount;
declare namespace _VueTestUtils {
  export { _VueTestUtils_BaseWrapper as BaseWrapper, _VueTestUtils_DOMWrapper as DOMWrapper, _VueTestUtils_RouterLinkStub as RouterLinkStub, _VueTestUtils_VueWrapper as VueWrapper, _VueTestUtils_config as config, _VueTestUtils_createWrapperError as createWrapperError, _VueTestUtils_disableAutoUnmount as disableAutoUnmount, _VueTestUtils_enableAutoUnmount as enableAutoUnmount, _VueTestUtils_flushPromises as flushPromises, mount$1 as mount, _VueTestUtils_renderToString as renderToString, _VueTestUtils_shallowMount as shallowMount };
  export type { ComponentMountingOptions$1 as ComponentMountingOptions, MountingOptions$1 as MountingOptions };
}

declare const VueTestUtils: Omit<typeof _VueTestUtils, 'mount' | 'shallowMount'>;
